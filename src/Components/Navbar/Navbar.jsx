      ...
      <div className='lg:flex justify-around gap-25 bg-black text-white items-center h-20 hidden fixed w-full top-0 z-50 shadow-xl '>
        ...
        <div className=''>
          <ul className='flex gap-8 text-xl'>
            ...
            <li className='bg-gradient-to-r from-green-800 to-green-950  px-3 py-2 rounded-sm hover:shadow-[0_0_20px_5px_rgba(0,255,0,0.8)] hover:scale-110 transition-all duration-300 font-medium'><Link to="/Hassan_Khaliq_Resume.pdf" target='blank'>Get Resume</Link></li>
          </ul>
        </div>
      </div>
    </>
