...
{/* Toggle Button */}
    ...
    >
      ...
      <li className=" px-3 py-2 rounded-sm transition-all duration-300 hover:scale-110 text-white  font-medium">
           ...
           <Link to="/Hassan.Resume.pdf" target='blank' onClick={() => setIsOpen(false)} className='bg-gradient-to-r from-green-800 to-green-950 px-15 py-2 rounded-sm transition-all duration-300 font-medium ml-4 mt-10'>Get Resume</Link>
      </ul>
    </div>
   </div>
