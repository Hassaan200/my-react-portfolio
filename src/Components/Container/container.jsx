...
const Container = ({ setIsOpen }) => {
  return (
    ...
    <div className='sm:max-w-[400px] max-w-[350px] sm:space-y-4 space-y-3 sm:text-left text-center' data-aos="zoom-in">
        ...
        <p className='md:text-[17px] text-[14px]'>Full Stack Developer skilled in React.js, Vue.js, Tailwind CSS, Node.js, Express.js, MySQL/MariaDB, and MongoDB, with experience building responsive front-end interfaces and scalable back-end systems.</p>
