    ...
    <div className='bg-[url("/images/service-pic.png")] bg-cover bg-center text-white'>
      <div className='flex flex-wrap pt-30 p-8 justify-center items-center gap-20  '>
        <div className='sm:max-w-[400px] max-w-[350px] sm:space-y-4 space-y-3 flex flex-col justify-center sm:text-left text-center' data-aos="fade-right">
          <h1 className='md:text-5xl sm:text-3xl text-2xl font-bold'>Services</h1>
          <p className=''>We provide complete IT services including network setup, cloud migration, cybersecurity, and ongoing technical support. Whether you need secure infrastructure, reliable maintenance, or expert consultation, our solutions are designed to keep your systems running smoothly and efficiently.</p>
          <div className='flex flex-wrap justify-center sm:justify-start sm:gap-8 gap-4 items-center'>
            ...
            <button className='border-1 rounded-sm cursor-pointer  px-4 py-1.5 flex items-center'><MdOutlineFileDownload className='text-xl ' /><a href="/Hassan_Khaliq_Resume.pdf" download="Hassan_khaliq_Resume.pdf">Download Resume</a></button>
          </div>
        </div>
        <div className='grid grid-rows-2 gap-4 lg:grid-cols-2 sm:grid-rows-1'>
          ...
          <div className="box flex flex-col bg-white/20 backdrop-blur-sm rounded-xl gap-4 justify-center w-[250px] p-5 py-10" data-aos="fade-down">
            ...
            <h1 className='text-3xl font-bold'>E-Commerce Solutions</h1>
            <p>From product listings to secure checkout, we build online stores that grow your sales.</p>
          ...
          <div className="box flex flex-col bg-white/20 backdrop-blur-sm rounded-xl gap-4 justify-center w-[250px] p-5 py-10" data-aos="fade-down">
            ...
            <p>Smart AI chatbots & WhatsApp, Facebook integrations that handle customer queries, bookings, and lead capture — 24/7, automatically..</p>
