      ...
      <div className='bg-[url("/images/bg-green.png")] bg-cover bg-center w-full h-[1245px]'>
        ...
        <div className='flex flex-wrap xl:pt-35 lg:pt-21 md:pt-38 pt-26 justify-center items-center xl:gap-[15rem] gap-20  px-4 ' data-aos="fade-up">
          <div className='lg:w-[400px] w-[320px] text-white text-center md:text-left '>
            ...
            <p className='text-sm sm:text-[16px] leading-tight mt-2'>
              I am a Full Stack Developer with a strong foundation in HTML, CSS, JavaScript, Node.js and modern libraries like React.js, Next.js, Vue.js and Tailwind CSS — with hands-on experience building responsive, user-friendly web apps and AI-powered SaaS products.
            </p>
